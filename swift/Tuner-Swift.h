...
#ifndef TUNER_ARM_SWIFT_H
#define TUNER_ARM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tuner_arm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Tuner_arm11AppDelegate")
...
SWIFT_CLASS("_TtC9Tuner_arm9TunerView")
@interface TunerView : NSView
...
SWIFT_CLASS("_TtC9Tuner_arm11DisplayView")
@interface DisplayView : TunerView
@property (nonatomic) BOOL lock;
@property (nonatomic) BOOL mult;
@property (nonatomic) NSInteger trans;
...
SWIFT_PROTOCOL("_TtP9Tuner_arm15EditMenuActions_")
...
SWIFT_CLASS("_TtC9Tuner_arm9MeterView")
...
SWIFT_CLASS("_TtC9Tuner_arm9ScopeView")
...
SWIFT_CLASS("_TtC9Tuner_arm12SpectrumView")
...
SWIFT_CLASS("_TtC9Tuner_arm9StaffView")
...
SWIFT_CLASS("_TtC9Tuner_arm10StrobeView")
